...
- **[Limpeza de Dados — RH IBM](https://github.com/luccasnn/limpeza-dados):** Tratamento de dados reais com pandas — remoção de duplicatas, valores impossíveis, nulos e inconsistências de texto.
